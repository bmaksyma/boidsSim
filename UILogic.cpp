...
int main() {
    ...
    int selectedColorID = 0;       // User-selected index
    uint16_t activeButtonColor = COLOR_GREEN;  // Default applied button color
    bool choosingColor = false;   // Are we in color selection mode?
    int fontID = 0;
    ...
    // mainWindow.drawWindow(parlcd_mem_base, fb);
    usleep(3 * 1000 * 1000);
